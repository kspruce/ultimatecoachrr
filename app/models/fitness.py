...
# Function to create default metrics if they don't exist
def create_default_metrics(target, connection, **kw):
    # This function runs after the tables are created
...
# Register the event listener to create default metrics after table creation
event.listen(FitnessMetric.__table__, 'after_create', create_default_metrics)
